...
idea.project.settings.delegateActions { // See https://github.com/JetBrains/gradle-idea-ext-plugin/wiki#delegating-runbuild-and-test-actions
    delegateBuildRunToGradle = false // Delegate Run/Build to Gradle
